...
if ( ! class_exists( 'etdabba_etcodes_walker_nav_menu' ) ) {
	/**
	 * etdabba_etcodes_walker_nav_menu class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class etdabba_etcodes_walker_nav_menu extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		public static function fallback( $args ) {
			if ( current_user_can( 'edit_theme_options' ) ) {
				...
				echo '>';
				echo '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '">' . esc_html_e( 'Add a menu', 'dabba' ) . '</a></li>';
				echo '</ul>';
				if ( $container ) {
					echo '</' . esc_attr( $container ) . '>'; }
			}
