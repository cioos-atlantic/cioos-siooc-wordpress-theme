...
add_action( 'tgmpa_register', 'etdabba_etcodes_register_required_plugins' );
/**
 ...
 */
function etdabba_etcodes_register_required_plugins() {

	$plugins = array(
		array(
			'name'     => esc_html__('Energetic Core Parts', 'dabba'),
		...
		array(
			'name'     => esc_html__('WooCommerce', 'dabba'),
			'slug'     => 'woocommerce',
			'required' => false,
		),
		array(
			'name'     => esc_html__('WooCommerce Blocks', 'dabba'),
			'slug'     => 'woo-gutenberg-products-block',
			'required' => false,
		),
		array(
			'name'     => esc_html__('MailChimp for WordPress', 'dabba'),
			'slug'     => 'mailchimp-for-wp',
			'required' => false,
		),
		array(
			'name'     => esc_html__('Contact Form 7', 'dabba'),
			'slug'     => 'contact-form-7',
			'required' => false,
		),
	);
