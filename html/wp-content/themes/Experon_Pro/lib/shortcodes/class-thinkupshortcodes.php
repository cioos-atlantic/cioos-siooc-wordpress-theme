...
// Add shortcodes
		...
		add_shortcode('tabs3', array($this, 'render_element'));
	...
	function add_metaboxes( $slug, $post = false ){
		...
		add_meta_box('_thinkup_meta_sliderimages', 'ThinkUpSlider', array($this, 'render_metaboxes'), 'product', 'normal', 'core', array( 'slug' => '_thinkup_meta_sliderimages', 'groups' => array('Slides','Height') ) );
...
<option value=\"tabs3\">".__('Style 3','thinkupshortcodes')."</option>
