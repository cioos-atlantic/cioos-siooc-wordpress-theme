...
if ( ! class_exists( 'thinkup_widget_tagscloud' ) ) {
	class thinkup_widget_tagscloud extends WP_Widget {
		...
		function widget($args, $instance) {		
			...
			echo $before_widget;
			$title = empty($instance['title']) ? __( 'Tags', 'experon' ) : apply_filters('widget_title', $instance['title']);
	...
	add_action( 'widgets_init', function() { return register_widget( "thinkup_widget_tagscloud" ); } );
}