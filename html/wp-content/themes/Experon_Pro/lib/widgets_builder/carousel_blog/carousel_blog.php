...
class thinkup_builder_carouselblogtheme extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		echo do_shortcode( '[carousel_blog items="' . $items .'" scroll="' . $scroll . '" speed="' . $speed . '" effect="' . $effect . '" title="' . $toggle_title . '" details="' . $toggle_details . '" category="' . $category . '" heading="' . $heading . '" link_icon="' . $link_icon . '" lightbox_icon="' . $lightbox_icon . '"]' );
...
add_action( 'widgets_init', function() { return register_widget( "thinkup_builder_carouselblogtheme" ); } );
