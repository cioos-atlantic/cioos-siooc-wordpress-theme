...
class thinkup_builder_services extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if ( empty( $style ) or $style == 'style1' ) {
			...
			echo do_shortcode( '[services1 image="' . $image . '" icon="' . $icon . '" heading="' . $heading . '" link="' . $link . '" link_text="' .  $link_text . '" animate="' . $animate . '" delay="' . $delay . '"]' . $text . '[/services1]' );

		} else if ( $style == 'style2' ) {

			echo do_shortcode( '[services2 icon="' . $icon . '" heading="' . $heading . '" link="' . $link . '" link_text="' .  $link_text . '" animate="' . $animate . '" delay="' . $delay . '"]' . $text . '[/services2]' );
