...
class thinkup_builder_carouselclient extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		echo do_shortcode( '[carousel_clients items="' . $items .'" scroll="' . $scroll . '" speed="' . $speed . '" effect="' . $effect . '"  category="' . $category . '" title="' . $heading . '"]' );
...
add_action( 'widgets_init', function() { return register_widget( "thinkup_builder_carouselclient" ); } );
