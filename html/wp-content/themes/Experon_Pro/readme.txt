...
Experon is a multi-purpose professional Premium WordPress Theme ideal for a business or blog website. The theme is responsive, HD retina ready and comes with 600+ Google Fonts which can easily be selected directly from the theme options panel. Never code again with the awesome page builder. Simply drag, drop and you're done! It couldn't be easier to create stunning websites with the beauty of Harest.


== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Experon Pro in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Go to Appearance - About Experon Pro in the admin area of your website for a guide on how to customize this theme.
5. Navigate to Appearance > Customize in your admin panel and customize to taste.


== Frequently Asked Questions ==

For setup instructions please refer to the Getting Started section in Knowledge Base. The Knowledge Base can be found in the Support Center over at www.thinkupthemes.com.
...
= 1.8.8
- New:     Child theme skin Minimal added.
- New:     Child theme skin Business added.

= 1.8.7
- Fixed:   WooCommerce v3.5.5 compatible.

= 1.8.6
- Fixed:   WooCommerce v3.5.1 compatible.

= 1.8.5
- Fixed:   WooCommerce v3.5.0 compatible.
...
- Updated: Improved https compatibility. 
- Updated: TGMPA updated to v2.6.1 (from Github).
...
- Fixed:   Breadcrumbs now display by default.
...
= 1.7.4
- New:     Class "align-rtl" can be used to align sub-menu in #header from right. Prevents sub-menu links being cut off.
- Updated: Bars in responsive header menu button now align centrally.

= 1.7.3
- Updated: Support added for Easy Digital Downloads.
- Updated: Read more button on blog pages only output if additional text is available to read.
- Updated: Page titles and breadcrumbs improved for improved compatibility with 3rd party templates.
- Removed: Function thinkup_input_readmore() removed from template files.
...
- Updated: Function "thinkup_input_headersticky" renamed to "thinkup_input_headerstickyclass".
...
- Updated: Escaping removed from header image url.
- Updated: Google fonts updated to include all Google fonts currently available.

= 1.7.0
- New:     Image slider added to replace page slider.
- New:     Migration script added to automatically migrate users of the page slider to the image slider.
- Fixed:   Various minor css bug fixes.
...
= 1.6.13
- Fixed:   List (Font Awesome) page builder module now displays icon correctly.
- Fixed:   Responsive header displays correctly when custom styling for responsive header is enabled.
...
= 1.6.11
- Updated: Improved translation in various files.
- Updated: Improved advanced custom styling options.
- Updated: Improved escaping of PHP outputs in various files.
- Updated: All instanced for "..." changed to "&hellip;" in template files.
- Updated: wp_link_pages() added following the_content() in template files.
- Updated: thinkup_customizer_select_array_sidebar() now checks for footer sidebars by id instead of name.
- Removed: html5 removed.
- Removed: Function thinkup_check_ishome() no longer required, as related issue is now fixed in core.
- Removed: thinkup_migrateF2P_settings_logo() removed as migration of logo image with no longer required.
...
- Updated: Page title prefixes now wrapped in span tags. Can now be hidden via css.
...
- Fixed:   jQuery for testimonial carousel updated to prevent bottom of testimonials from getting cut off.
- Updated: Theme now fully compatible with PHP7.
- Updated: Header image option added to theme options.
- Updated: Sanitization and escaping of unknown outputs improved.
- Updated: Advanced custom styling options added for responsive header menu.
- Updated: Fallback validation only outputs if API key is not activated. Improves pages load speed.
- Updated: Function getPostLikeLink() renamed to thinkup_woo_getPostLikeLink() to reduce risk of conflict with 3rd party code.
...
- Fixed:   Anchor for ResponsiveSlides updated to "responsiveslides" and "thinkup-responsiveslides". Ensures slider displays correctly for responsive design.
...
= 1.6.4
- Fixed:   Slider full width option now works with page slider.
- Fixed:   Background in admin now displays correct WP default color scheme.
- Fixed:   WooCommerce related.php file updated to ensure PHP error doesn't show on single product page.
- Updated: Minor stlying updates in woocommerce-theme.css.
- Updated: Categories can now be assigned to testimonials custom post type.
- Updated: Function thinkup_input_addimagesizes() now child theme comatible.
- Updated: Function thinkup_input_showimagesizes() now child theme comatible.
- Updated: Anchor for Retina.js script changed from "thinkup-retina" to "retina".
- Updated: Content width implementation updated to be hooked into "after_theme_setup".
- Updated: "thinkup" prefix removed from anchor of all 3rd party scripts and stylesheets.
- Updated: Order of sript ans stylesheets in functions.php updated to load 3rd party scripts first.
- Updated: Logo migration script updated to allow migration if free theme options are stored in option "theme_mods_experon".
...
- Fixed:   Escaped $slide_alt and $slide_image with esc_attr() in 02.homepage.php.
...
- Fixed:   "test333" text removed. This should not have been present in released version of theme.
- Updated: Improved validation for various outputs.
- Updated: Minor stlying updates in woocommerce-theme.css.
...
- Updated: Various styling updates to woocommerce-theme.css.
- Updated: Sanitization and escaping of unknown outputs improved.
- Updated: Custom logo variable "thinkup_general_logosetting" default value set to 0.
...
- Updated: Theme colors in woocommerce-theme.css no longer applied using !important tag to allow colors to be overwritten by 1 click color changer.
...
- Updated: Progress bar shortcodes updated to be consisten with latest page builder update.
...
= 1.5.9
- Fixed:   themebutton styling updated to ensure that link icon is white regardless of button text size.
...
= 1.5.8
- New:     Custom logo support added for WordPress v4.5.
- New:     3 slide page slider added as a slider option.
- New:     Theme options logo settings disabled by default. User can switch to "on" to control logo settings from theme options panel.
- Fixed:   Bottom of customizer section no longer cuts off.
...
- Fixed:   Start and end links from product on WooCommerce Shop page removed - Causes issues with lightbox and like buttons.
...
- Updated: Custom Redux extension thinkup_custom_code updated - preview panel no longer moves.
- Updated: Translation .pot file updated to take account of recent updates in core theme files.
...
- Removed: Redux developer mode notice removed.
...
- Fixed:   WooCommerce "shop" page title now displays correctly.
...
= 1.5.3
- New:     Custom header support added.
- New:     Custom background support added.
...
- Updated: ID "site-header" added to header html tag. Previously was added using separate div tag.

= 1.5.2
- New:     Slider speed setting now added to ThinkUpSlider.
- New:     Link to Email can now be added from theme options panel.
- New:     Developer version of responsiveslides.js added to theme folder.
- New:     Link to Xing social profice can now be added from theme options panel.
- New:     Link to Vimeo social profice can now be added from theme options panel.
- New:     Link to PayPal social profice can now be added from theme options panel.
- Fixed:   Social switch for footer now works correctly.
- Updated: 1 click demo installed uses output from new demo server.
- Updated: Google fonts now added using function thinkup_googlefonts_url().
- Updated: Translation .pot file updated to take account of recent updates in core theme files.
- Updated: Function thinkup_input_blogimage() updated to return output rather than echo output.
- Updated: Function thinkup_input_breadcrumb() updated to return output rather than echo output.
- Updated: Text domain for all translatable text in WooCommerce bundled files changes to "experon".
...
- Removed: Fonts folder removed from theme directory.

= 1.5.1
- Fixed:   style-responsive.css anchor changed to thinkup-responsive. Stylesheet for responsive layout now correctly output.
- Updated: Translation .pot file updated to take account of recent updates in core theme files.

= 1.5.0
- Updated: Various css updates to WooCommerce pages.
- Updated: Theme name changed from "Experon" to "Experon Pro".
- Updated: Update notice compatible with Pro suffix on theme name.
- Updated: Text domain changed from 'lan-thinkupthemes' to 'experon'.
...
- Updated: Homepage (Content) section available to use in theme options panel.
...
- Removed: Notice for pending Pro update name change removed.

= 1.4.1
- New:     Notice for pending Pro update name change added.
- New:     License verification script added to improve theme security.
- New:     Homepage (Content) section code added - commented out. To be activated in v1.5.0.
- Fixed:   Checkbox now displays correctly in theme options panel. Problem of stretched checkbox resolved.
- Fixed:   ThinkUpSlider button text in theme options panel now works correctly for all slider types (standard and video).
- Updated: Text shadow from save button in customizer.
- Updated: Page builder module now uses services shortcode to generate output.
- Updated: Page titles now display on left and breadcrumbs on the right side of the page.
- Updated: Services style 1 now has an image variation. Image is used if image is set, otherwise icon is output.
- Removed: Redundant Redux code removed from main-backend.js.

= 1.4.0
- New:     Dashicons now enqueued directly from WordPress core.
- Fixed:   Redux notices prevented from displaying - fixed css selector.
- Fixed:   Font color in #sub-footer now displays correct color of #717171.
...
- Updated: Padding-right on quantity incrementer in single product page changed from 15px.
...
- Updated: Redux global variable changed from $redux -> $thinkup_redux_variables. Migration function thinkup_migrate_redux_option().
...
- Updated: CMB Metabox framework updated to v1.2.0.
- Updated: style-shortcodes.css updated to be consistent with all themes.
...
- Updated: Theme specific woocommer.css split into 2 files. woocommerce.css and woocommerce-theme.css.
...
= 1.3.2
- Fixed:   Porftfolio custom excerpt field removed. Replaced with default WordPress excerpt field.
...
= 1.2.0
- Fixed:   Update script fixed to correctly point to www.thinkupthemes.com.
- Updated: Global variable used for theme options panel changed from $thinkup_redux_variables to $redux.
- Updated: Sub-header names in Custom styling section of theme options panel updated to make it easier to understand what the options are for.
- Updated: Demo data updated to ensure compatibility with change in theme options global variable.
