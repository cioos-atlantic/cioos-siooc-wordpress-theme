<?php
    ...
    function assetmap_scripts() {
        ...
        // SCRIPTS
            ...
            wp_enqueue_script( 'assetui', get_stylesheet_directory_uri() . '/asset/js/asset_ui.js', array('jquery'), '', false   );
...
//===================================================================================
    ...
    function addheaders() {        
        ...
        header("Content-Security-Policy: default-src 'self' 'unsafe-inline' 'unsafe-eval' *.amazonaws.com *.googleapis.com *.wikimedia.org *.hakai.org *.cioos.org *.cioos.ca *.canada.ca d3js.org *.cloudflare.com *.gstatic.com unpkg.com *.bootstrapcdn.com *.rawgit.com *.polyfill.io *.gebco.net *.mailchimp.com cdn-images.mailchimp.com *.dropboxusercontent.com/s/pxxqg90g7zxtt8n/q67JXA0dJ1dt.js *.gravatar.com *.arcgis.com data: ;");
