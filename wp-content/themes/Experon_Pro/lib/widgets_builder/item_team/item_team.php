...
class thinkup_builder_itemteam extends WP_Widget {
	...
	function form($instance) {
		...
		echo '<p><label for="' . $this->get_field_id('link_style') . '" style="display: inline-block;width: 150px;">Link Style:</label>
			<select name="' . $this->get_field_name('link_style') . '" id="' . $this->get_field_id('link_style') . '" class="widget-thinkup_builder_itemteam" style="display: inline-block;width: 200px;margin: 0;">
			<option '; ?><?php if($link_style == "on") { echo "selected"; } ?><?php echo ' value="style1">Style 1</option>
			<option '; ?><?php if($link_style == "off") { echo "selected"; } ?><?php echo ' value="style2">Style 2</option>
			</select>
		</p>';
	...
	function widget($args, $instance) {
		...
		echo do_shortcode( '[item_team id="' . $post_id . '" size="' . $size . '" show_link="' . $show_link . '" link_style="' . $link_style . '" show_name="' . $show_name . '" show_position="' . $show_position . '" show_excerpt="' . $show_excerpt . '" show_social="' . $show_social . '"]' );
...
add_action( 'widgets_init', function() { return register_widget( "thinkup_builder_itemteam" ); } );
