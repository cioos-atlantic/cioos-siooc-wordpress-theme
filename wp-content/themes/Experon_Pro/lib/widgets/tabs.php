	...
	class thinkup_widget_tabs extends WP_Widget {
		...
		global $post;
			...
			echo	'<ul class="nav nav-tabs">',
						'<li class="active"><a href="#widgetpopular-' . $current_instance_id . '" data-toggle="tab"><h3 class="widget-title">' . __( 'Popular', 'experon' ) . '</h3></a></li>',
						'<li><a href="#widgetrecent-' . $current_instance_id . '" data-toggle="tab"><h3 class="widget-title">' . __( 'Recent', 'experon' ) . '</h3></a></li>',
					'</ul>';
